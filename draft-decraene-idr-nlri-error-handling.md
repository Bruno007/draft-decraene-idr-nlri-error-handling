...
# NLRI_KEY_LIST attribute {#format}

The NLRI_KEY_LIST attribute is an optional, non-transitive BGP path attribute with type code TBD1. 
The format of the NLRI_KEY_LIST attribute is the same as the format of the MP_UNREACH_NLRI as defined in Section 4 of {{RFC4760}}.
...
A BGP speaker MUST NOT send the NLRI_KEY_LIST attribute unless its peer has advertised the NLRI_KEY_LIST Capability.
...
IANA is requested to allocate a new capability called "TNLRI_KEY_LIST" from the Capability Codes registry.
